                ...
                <div className="relative flex flex-col md:flex-row gap-8 items-stretch">
                    ...
                    {steps.map((step, i) => (
                        <motion.div
                            ...
                            className="flex-1 glass p-12 rounded-[4rem] border border-white/5 flex flex-col items-center text-center relative group overflow-hidden bg-[#030303]/40 backdrop-blur-xl"
                        >
                            ...
                            <motion.div
                                ...
                                className="w-24 h-24 rounded-3xl bg-[#A78BFA]/10 border border-[#A78BFA]/20 flex items-center justify-center mb-10 group-hover:scale-110 group-hover:bg-[#A78BFA] group-hover:text-black transition-all duration-700 shadow-2xl relative z-10"
                            >
